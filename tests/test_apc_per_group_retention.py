...
# LOCAL: __main__-style host test (needs live copies of the fork's coordinator);
# not collectable by pytest — run directly, see docs/06 W25.
if "pytest" in sys.modules:
    import pytest
    pytest.skip("host test - run directly with the GLM53_KV_COORDINATOR_PY_* envs",
