...
//                           A-tile is fused gather: had128(x[token[row]] * gate_suh[expert])
...
// num_segs is a 1-element int32 device tensor; kernels are launched with
// capacity-sized, grid-strided grids and read the live counts.
